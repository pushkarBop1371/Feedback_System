 ...
 * checks (hasRole, authenticated(), etc.) work for this request.
 * Requests with no/invalid token simply fall through unauthenticated -
 * whether that's allowed depends on SecurityConfig's rules for the path.
 */
@Component
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            // and let SecurityConfig's access rules decide the response (401/403).
